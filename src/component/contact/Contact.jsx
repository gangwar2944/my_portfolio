      ...
      <div className='container contact_container'>
        <div className='contact_options'>
         <article className='contact_option'>
           ...
           <a href='mailto:vishalgangwar094@gamil.com' target='_blank'>send email here</a>
         </article>
         <article className='contact_option'>
         ...
         <article className='contact_option'>
           ...
           <h4>Whats app</h4>
           <h5>+8840216454</h5>
           <a href='https://api.whatsapp.com/send?+918840216454' target='_blank'>send email here</a>
         </article>
        </div>
